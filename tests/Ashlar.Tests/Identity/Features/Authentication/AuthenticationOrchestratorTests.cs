...
internal sealed class AuthenticationOrchestratorTests
{
    ...
    public void ConstructorThrowsWhenDependenciesAreNull()
    {
        using (Assert.EnterMultipleScope())
        {
            ...
            Assert.Throws<ArgumentNullException>(() => _ = new AuthenticationOrchestrator(_pipelineMock.Object, _factorPipelineMock.Object, _handshakeServiceMock.Object, null!, _handshakeCompletionService, _policyEvaluatorMock.Object, _providerRegistry));
    ...
    public async Task VerifyFactorAsyncUsesDefaultErrorWhenHandshakeServiceFailsWithoutDetails()
    {
        ...
        _handshakeCompletionService.CompletionResult = new Result<AuthenticationHandshake>(false);
