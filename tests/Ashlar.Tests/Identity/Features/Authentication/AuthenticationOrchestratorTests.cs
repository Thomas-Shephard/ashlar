...
internal sealed class AuthenticationOrchestratorTests
{
    ...
    public void SetUp()
    {
        ...
        _handshakeServiceMock
            .Setup(h => h.BeginVerificationAsync(It.IsAny<BeginAuthenticationHandshakeVerificationRequest>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(() => Result.Success(new AuthenticationHandshake(
                Guid.NewGuid(),
                _userMock.Object.Id,
                "hash",
                ...
                false,
                false,
                new HashSet<string> { AuthenticationFactorTypes.Totp },
                new HashSet<string>())));
    }
    ...
    public async Task AuthenticateAsyncSucceedsWhenNoMfaRequired()
    {
        ...
        _pipelineMock.Setup(p => p.LoginAsync(It.IsAny<AuthenticationContext>(), _assertionMock.Object, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(_userMock.Object, AuthenticationStatus.SuccessWithCredentialUpdate, AuthenticationClaims.FromSingleValues(claims), CredentialUpdatePersisted: true));
    ...
    {
        _pipelineMock.Setup(p => p.LoginAsync(It.IsAny<AuthenticationContext>(), _assertionMock.Object, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(_userMock.Object, AuthenticationStatus.SuccessWithCredentialUpdate));
    ...
    public void ConstructorThrowsWhenDependenciesAreNull()
    {
        using (Assert.EnterMultipleScope())
        {
            Assert.Throws<ArgumentNullException>(() => _ = new AuthenticationOrchestrator(null!, _factorPipelineMock.Object, _handshakeServiceMock.Object, _handshakeCompletionService, _policyEvaluatorMock.Object, _providerRegistry));
            Assert.Throws<ArgumentNullException>(() => _ = new AuthenticationOrchestrator(_pipelineMock.Object, null!, _handshakeServiceMock.Object, _handshakeCompletionService, _policyEvaluatorMock.Object, _providerRegistry));
            Assert.Throws<ArgumentNullException>(() => _ = new AuthenticationOrchestrator(_pipelineMock.Object, _factorPipelineMock.Object, null!, _handshakeCompletionService, _policyEvaluatorMock.Object, _providerRegistry));
    ...
    {
        _handshakeServiceMock
            .Setup(h => h.BeginVerificationAsync(
                It.Is<BeginAuthenticationHandshakeVerificationRequest>(request => request.HandshakeToken == token),
    ...
    public async Task AuthenticateAsyncReturnsMfaRequiredWhenPolicyRequiresMfa()
    {
        var claims = new Dictionary<string, string> { ["test"] = "value" };
        _pipelineMock.Setup(p => p.LoginAsync(It.IsAny<AuthenticationContext>(), _assertionMock.Object, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(_userMock.Object, AuthenticationStatus.Success, AuthenticationClaims.FromSingleValues(claims)));
    ...
    public async Task AuthenticateAsyncFallsBackToMfaHandshakeWhenRememberedDeviceTokenIsInvalid(RememberedMfaDeviceValidationStatus status)
    {
        ...
        _pipelineMock.Setup(p => p.LoginAsync(It.IsAny<AuthenticationContext>(), _assertionMock.Object, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(_userMock.Object, AuthenticationStatus.Success));
        _policyEvaluatorMock.Setup(e => e.EvaluateAsync(_userMock.Object, context, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new MfaPolicyEvaluation(true, new MfaRequirement(["totp"])));
        _handshakeServiceMock.Setup(h => h.CreateHandshakeAsync(It.IsAny<CreateAuthenticationHandshakeRequest>(), It.IsAny<CancellationToken>()))
    ...
    public async Task AuthenticateAsyncDoesNotBypassProviderForcedMfaWithRememberedDeviceToken()
    {
        var context = _context.WithRememberedMfaDeviceToken("remembered-token");
        _pipelineMock.Setup(p => p.LoginAsync(It.IsAny<AuthenticationContext>(), _assertionMock.Object, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(_userMock.Object, AuthenticationStatus.MfaRequired));
        _policyEvaluatorMock.Setup(e => e.EvaluateAsync(_userMock.Object, context, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new MfaPolicyEvaluation(true, new MfaRequirement(["totp"])));
        _handshakeServiceMock.Setup(h => h.CreateHandshakeAsync(It.IsAny<CreateAuthenticationHandshakeRequest>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(Result.Success(CreateHandshakeCreated(
    ...
    public async Task AuthenticateAsyncUsesProviderMfaFactorsWhenPolicyHasNone()
    {
        ...
        _pipelineMock.Setup(p => p.LoginAsync(It.IsAny<AuthenticationContext>(), _assertionMock.Object, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(_userMock.Object, AuthenticationStatus.MfaRequired, AuthenticationClaims.FromSingleValues(claims)));
    ...
    {
        _pipelineMock.Setup(p => p.LoginAsync(It.IsAny<AuthenticationContext>(), _assertionMock.Object, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(Status: AuthenticationStatus.Failed));
    ...
    {
        _pipelineMock.Setup(p => p.LoginAsync(It.IsAny<AuthenticationContext>(), _assertionMock.Object, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(_userMock.Object, AuthenticationStatus.Disabled));
    ...
    {
        _pipelineMock.Setup(p => p.LoginAsync(It.IsAny<AuthenticationContext>(), _assertionMock.Object, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(Status: AuthenticationStatus.RateLimited));
    ...
    public async Task VerifyFactorAsyncSucceedsAndReturnsHandshakeIncomplete()
    {
        ...
        _factorPipelineMock.Setup(p => p.VerifyFactorAsync(It.IsAny<AuthenticationContext>(), _assertionMock.Object, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(_userMock.Object, AuthenticationStatus.SuccessWithCredentialUpdate, CredentialUpdatePersisted: true));
    ...
    public async Task VerifyFactorAsyncUsesSecondaryFactorPipelineScopeOnly()
    {
        ...
        factorPipeline
            .Setup(p => p.VerifyFactorAsync(
                ...
                It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(_userMock.Object, AuthenticationStatus.Success));
        handshakeCompletionService.CompletionResult = Result.Success(updatedHandshake);
    ...
    [Test]
    public async Task VerifyFactorAsyncFailsWhenBeginFails()
    {
        var logger = new RecordingLogger<AuthenticationOrchestrator>();
        var orchestrator = CreateOrchestrator(logger);
        _handshakeServiceMock.Setup(h => h.BeginVerificationAsync(It.IsAny<BeginAuthenticationHandshakeVerificationRequest>(), It.IsAny<CancellationToken>()))
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            Assert.That(logger.Entries, Has.Some.Matches<LogEntry>(entry =>
                entry.Level == LogLevel.Debug
                && entry.Message.Contains("Reason=validation_error", StringComparison.Ordinal)));
        }
    }
    ...
    public async Task VerifyFactorAsyncFailsBeforeAuthenticationWhenHandshakeVerificationIsRateLimited()
    {
        ...
        _factorPipelineMock.Verify(p => p.VerifyFactorAsync(It.IsAny<AuthenticationContext>(), It.IsAny<IAuthenticationAssertion>(), It.IsAny<CancellationToken>()), Times.Never);
        Assert.That(_handshakeCompletionService.Calls, Is.Empty);
    }
    ...
    public async Task VerifyFactorAsyncForwardsCanonicalRequiredFactor()
    {
        ...
        {
            Assert.That(result.Status, Is.EqualTo(MfaAuthenticationStatus.Succeeded));
            Assert.That(_handshakeCompletionService.Calls.Single().FactorType, Is.EqualTo("TOTP"));
        }
    }
    ...
    public async Task VerifyFactorAsyncAuthorizesCustomSecondaryProviderByFactorType()
    {
        ...
        {
            Assert.That(result.Status, Is.EqualTo(MfaAuthenticationStatus.Succeeded));
            Assert.That(_handshakeCompletionService.Calls.Single().FactorType, Is.EqualTo("custom_step_up"));
        }
    }
    ...
    public async Task VerifyFactorAsyncAllowsRecoveryCodeToSatisfyNextPendingFactor()
    {
        ...
        var recoveryProvider = CreateBackupProvider(
            ...
            factorType => !string.IsNullOrWhiteSpace(factorType));
        ...
        Assert.That(result.Status, Is.EqualTo(MfaAuthenticationStatus.Succeeded));
        _handshakeServiceMock.Verify(h => h.BeginVerificationAsync(
            It.Is<BeginAuthenticationHandshakeVerificationRequest>(r => r.HandshakeToken == "token"),
            It.IsAny<CancellationToken>()));
        Assert.That(_handshakeCompletionService.Calls.Single().FactorType, Is.EqualTo("passkey"));
    }

    [Test]
    public async Task VerifyFactorAsyncAllowsCustomBackupProviderToSatisfyPendingFactor()
    {
        var providerKey = new AuthenticationProviderKey("Custom", "BackupFactor");
        var assertion = new Mock<IAuthenticationAssertion>();
        assertion.Setup(a => a.ProviderIdentity).Returns(providerKey);
        var backupProvider = CreateBackupProvider(
            providerKey,
            "custom_backup",
            factorType => AuthenticationFactorTypes.Matches(AuthenticationFactorTypes.Totp, factorType));
        var providerRegistry = CreateProviderRegistry(backupProvider.Object);
        var orchestrator = new AuthenticationOrchestrator(
            _pipelineMock.Object,
            _factorPipelineMock.Object,
            _handshakeServiceMock.Object,
            ...
            _policyEvaluatorMock.Object,
            providerRegistry);
        var handshake = new AuthenticationHandshake(Guid.NewGuid(), _userMock.Object.Id, "hash", DateTimeOffset.UtcNow, DateTimeOffset.UtcNow.AddMinutes(5), false, false, new HashSet<string> { AuthenticationFactorTypes.Totp }, new HashSet<string>());
        _handshakeServiceMock.Setup(h => h.BeginVerificationAsync(It.IsAny<BeginAuthenticationHandshakeVerificationRequest>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(Result.Success(handshake));
        _factorPipelineMock.Setup(p => p.VerifyFactorAsync(It.IsAny<AuthenticationContext>(), assertion.Object, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(_userMock.Object, AuthenticationStatus.Success));
        ...
        {
            Assert.That(result.Status, Is.EqualTo(MfaAuthenticationStatus.Succeeded));
            Assert.That(_handshakeCompletionService.Calls.Single().FactorType, Is.EqualTo(AuthenticationFactorTypes.Totp));
        }
    }

    [Test]
    public async Task VerifyFactorAsyncAllowsRecoveryCodeAssertionToSatisfyTotpRequiredHandshake()
    {
        var assertion = new RecoveryCodeAssertion("ABCD-EFGH-IJKL");
        var recoveryProvider = new RecoveryCodeAuthenticationProvider(
            new PasswordHasherSelector([new PasswordHasherV1()]),
            Options.Create(new RecoveryCodeOptions()));
        var providerRegistry = CreateProviderRegistry(recoveryProvider);
        var orchestrator = new AuthenticationOrchestrator(
            _pipelineMock.Object,
            _factorPipelineMock.Object,
            _handshakeServiceMock.Object,
    ...
    [Test]
    public async Task VerifyFactorAsyncRequiresBackupProviderFactorNameForBackupSubstitution()
    {
        var assertion = new RecoveryCodeAssertion("ABCD-EFGH-IJKL");
        var recoveryProvider = new RecoveryCodeAuthenticationProvider(
            new PasswordHasherSelector([new PasswordHasherV1()]),
        ...
        var result = await orchestrator.VerifyFactorAsync("token", AuthenticationFactorTypes.Totp, _context, assertion);
    ...
    [Test]
    public async Task VerifyFactorAsyncDoesNotLetRecoveryCodeBypassHandshakeChecks()
    {
        var assertion = new RecoveryCodeAssertion("ABCD-EFGH-IJKL");
        var recoveryProvider = new RecoveryCodeAuthenticationProvider(
            new PasswordHasherSelector([new PasswordHasherV1()]),
        ...
        var result = await orchestrator.VerifyFactorAsync("missing-token", AuthenticationFactorTypes.RecoveryCode, _context, assertion);
    ...
    public async Task VerifyFactorAsyncFailsWhenHandshakeServiceFails()
    {
        ...
        _handshakeCompletionService.CompletionResult = Result.Failure<AuthenticationHandshake>(AshlarFailureCodes.HandshakeExpired);
    ...
    public async Task VerifyFactorAsyncMapsHandshakeFailureReasonsToPublicMessages(string failureReason, string expectedMessage)
    {
        ...
        _handshakeCompletionService.CompletionResult = Result.Failure<AuthenticationHandshake>(new AshlarFailureCode(failureReason));
    ...
    public async Task VerifyFactorAsyncUsesDefaultErrorWhenHandshakeServiceFailsWithUnknownReason()
    {
        ...
        _handshakeCompletionService.CompletionResult = Result.Failure<AuthenticationHandshake>(new AshlarFailureCode("unexpected_internal_reason"));
    ...
    [Test]
    public async Task VerifyFactorAsyncUsesDefaultErrorForUnknownHandshakeFailure()
    {
        var handshake = new AuthenticationHandshake(Guid.NewGuid(), _userMock.Object.Id, "hash", DateTimeOffset.UtcNow, DateTimeOffset.UtcNow.AddMinutes(5), false, false, new HashSet<string> { "totp" }, new HashSet<string>());
        _handshakeServiceMock.Setup(h => h.BeginVerificationAsync(It.IsAny<BeginAuthenticationHandshakeVerificationRequest>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(Result.Success(handshake));
        ...
        _handshakeCompletionService.CompletionResult = Result.Failure<AuthenticationHandshake>(new AshlarFailureCode("unknown"));
    ...
    [Test]
    public async Task AuthenticateAsyncUsesDefaultErrorForUnknownHandshakeFailure()
    {
        _pipelineMock.Setup(p => p.LoginAsync(It.IsAny<AuthenticationContext>(), _assertionMock.Object, It.IsAny<CancellationToken>()))
            .ReturnsAsync(new AuthenticationResponse(_userMock.Object, AuthenticationStatus.Success));
        ...
        _handshakeServiceMock.Setup(h => h.CreateHandshakeAsync(It.IsAny<CreateAuthenticationHandshakeRequest>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(Result.Failure<AuthenticationHandshakeCreated>(new AshlarFailureCode("unknown")));
