...
internal sealed class PostgresAuthenticationSessionAdministrationRepository(IPostgresConnectionProvider connectionProvider) : IAuthenticationSessionAdministrationRepository
{
