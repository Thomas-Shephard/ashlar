...
public static class AshlarSqliteServiceCollectionExtensions
{
        ...
        string connectionString)
    {
        ...
        services.TryAddScoped<IRememberedMfaDeviceRepository, SqliteRememberedMfaDeviceRepository>();
        ...
        Action<SqliteSecurityEventWebhookOutboxOptions>? configure = null)
    {
        ...
        services.Replace(ServiceDescriptor.Scoped<IAshlarSecurityEventWebhookOutboxOperations, SqliteSecurityEventWebhookOutboxOperations>());
