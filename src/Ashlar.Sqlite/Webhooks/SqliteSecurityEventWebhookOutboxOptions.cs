...
/// <summary>
/// Options for the SQLite-backed security event webhook outbox.
/// </summary>
public sealed record SqliteSecurityEventWebhookOutboxOptions
{
    /// <summary>
    ...
    internal static bool Validate(SqliteSecurityEventWebhookOutboxOptions options)
    {
