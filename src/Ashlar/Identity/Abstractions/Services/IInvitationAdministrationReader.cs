...
public interface IInvitationAdministrationReader
{
    ...
    Task<Result<InvitationSearchResult>> SearchInvitationsAsync(AccountSecurityActorContext actor, SearchInvitationsRequest request, CancellationToken cancellationToken = default);
    ...
    Task<Result<InvitationAdministrationSummary>> GetInvitationAsync(AccountSecurityActorContext actor, InvitationAdministrationLookupRequest request, CancellationToken cancellationToken = default);
}
