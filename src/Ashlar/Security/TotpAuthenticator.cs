...
internal static class TotpAuthenticator
{
    ...
    /// <summary>
    /// Generates an HOTP code for a shared secret and counter.
    /// </summary>
    /// <param name="key">The shared secret bytes. Do not log this value.</param>
    /// <param name="counter">The moving counter value to encode.</param>
    /// <param name="digits">The number of digits to return. Supported values are 6 through 8.</param>
    /// <returns>The zero-padded numeric code for the supplied counter.</returns>
...
#pragma warning restore CA5350
    ...
    /// <summary>
    /// Verifies an HOTP code for a single counter value.
    /// </summary>
    /// <param name="key">The shared secret bytes. Do not log this value.</param>
    /// <param name="code">The user-supplied numeric code. Do not log this value.</param>
    /// <param name="counter">The counter value expected for this attempt.</param>
    /// <param name="digits">The number of digits expected in <paramref name="code" />.</param>
    /// <returns><see langword="true" /> when the code matches the supplied counter.</returns>
    ...
    /// <summary>
    /// Verifies a TOTP code within the configured clock-skew window.
    /// </summary>
    /// <param name="key">The shared secret bytes. Do not log this value.</param>
    /// <param name="code">The user-supplied numeric code. Do not log this value.</param>
    /// <param name="time">The time to use when calculating the current TOTP step.</param>
    /// <param name="stepSeconds">The number of seconds in each TOTP step.</param>
    /// <param name="digits">The number of digits expected in <paramref name="code" />.</param>
    /// <param name="skewSteps">The number of adjacent time steps accepted before and after the current step.</param>
    /// <returns>Whether verification succeeded and the matched time step.</returns>
    ...
    /// <summary>
    /// Creates an otpauth URI that can be imported by authenticator applications.
    /// </summary>
    /// <param name="type">The OTP type, such as <c>totp</c> or <c>hotp</c>.</param>
    /// <param name="secret">The Base32 shared secret. The URI exposes this secret and must not be logged.</param>
    /// <param name="accountName">The account label shown by authenticator applications.</param>
    /// <param name="issuer">The issuer label shown by authenticator applications.</param>
    /// <param name="digits">The number of digits generated by the authenticator.</param>
    /// <param name="period">The TOTP period in seconds.</param>
    /// <returns>An otpauth URI containing the shared secret.</returns>
