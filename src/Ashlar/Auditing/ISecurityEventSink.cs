...
public interface ISecurityEventSink
{
    ...
    /// <returns>
    /// A task that completes after durable persistence and required transaction-bound continuations when configured,
    /// and after any immediate best-effort application forwarding has been attempted.
    /// </returns>
